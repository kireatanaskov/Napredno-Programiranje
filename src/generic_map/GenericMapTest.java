...
public class GenericMapTest {
    public static void main(String[] args) {
        ...
        if (testCase == 1) { //Mergeable integers
            ...
            MergeStrategy<Integer> mergeStrategy = (l, r) -> l + r;
            ...
            MergeStrategy<String> mergeStrategy = (l, r) -> l + r;
            ...
            MergeStrategy<String> mergeStrategy = (l, r) -> l.replace(r, IntStream.range(0, r.length()).mapToObj(i->"*").collect(Collectors.joining("")));
            printMap(MapOps.merge(mapLeft, mapRight, mergeStrategy));
        }
    }
